...
# Функции контроллера для диаграмм
def charts_page():
...
def get_gantt_data(project_id):
    ...
    return GanttDataView.render_json(result)

# Регистрируем маршруты
charts_bp.add_url_rule('/', view_func=charts_page, endpoint='charts')
charts_bp.add_url_rule('/api/project/<int:project_id>/gantt', view_func=get_gantt_data, endpoint='get_gantt_data')
